...
class DataEllipseDataset(Dataset):
    """
...
class DataEllipseDataModule(pl.LightningDataModule):
    def __init__(
        self,
        images_dir: str,
        annotations_dir: str,
