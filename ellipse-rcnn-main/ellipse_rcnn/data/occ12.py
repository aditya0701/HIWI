...
class occ12EllipseDataset(Dataset):
    """
...
class occ12EllipseDataModule(pl.LightningDataModule):
    def __init__(
        self,
        images_dir: str,
        annotations_dir: str,
