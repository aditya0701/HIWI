...
class occ16EllipseDataset(Dataset):
    """
...
class occ16EllipseDataModule(pl.LightningDataModule):
    def __init__(
        self,
        images_dir: str,
        annotations_dir: str,
