...
class occ20EllipseDataset(Dataset):
    """
...
class occ20EllipseDataModule(pl.LightningDataModule):
    def __init__(
        self,
        images_dir: str,
        annotations_dir: str,
