...
class occ4EllipseDataset(Dataset):
    """
...
class occ4EllipseDataModule(pl.LightningDataModule):
    def __init__(
        self,
        images_dir: str,
        annotations_dir: str,
