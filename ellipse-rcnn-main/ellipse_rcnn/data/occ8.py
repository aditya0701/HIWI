...
class occ8EllipseDataset(Dataset):
    """
...
class occ8EllipseDataModule(pl.LightningDataModule):
    def __init__(
        self,
        images_dir: str,
        annotations_dir: str,
